...
-- Diese Filetypes sollen den Winbar nicht anzeigen
local winbar_filetype_exclude = {
  "help", "startify", "dashboard", "packer", "neogitstatus", "NvimTree",
  "Trouble", "alpha", "lir", "Outline", "spectre_panel", "toggleterm",
}

-- Farbdefinitionen für WinBar
...
-- Hauptfunktion zur Generierung der WinBar
function M.winbar()
